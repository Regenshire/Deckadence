...
DECK_ART_CACHE_DIR = os.path.join(DATA_ROOT_DIR, "deck_art_cache")
DECK_ART_GENERATED_DIR = os.path.join(DATA_ROOT_DIR, "deck_art_generated")
DECK_ART_SOURCE_DIR = os.path.join(DATA_ROOT_DIR, "deck_art_sources")
