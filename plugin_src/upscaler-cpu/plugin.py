...
PLUGIN_ID = "upscaler-cpu"
PLUGIN_NAME = "CPU Upscaler"
...
HARDWARE_CAPABILITIES = {
    ...
    "supports_memory_reporting": False,
}
...
def build_hardware_status():
    ...
    result = {
        ...
        # Preserve the common hardware result
        # shape used by Deckadence.
        "cpu_available": (
            torch is not None
        ),
